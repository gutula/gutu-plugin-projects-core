...
- Package root: `framework/builtin-plugins/projects-core`
- Service layer: `framework/builtin-plugins/projects-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/projects-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/projects-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/projects-core/src/ui`

## Safe assumptions

- Use `projects-core` as the stable plugin identifier and `@plugins/projects-core` as the package import name.
