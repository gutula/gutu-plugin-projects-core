...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Projects Control Room"),
    React.createElement("p", null, "Project execution truth, milestone posture, and billing readiness for delivery-led work."),
    React.createElement(
      "p",
      null,
