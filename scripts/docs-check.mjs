...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/projects-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-projects-core:");
...
console.log("Documentation check passed for gutu-plugin-projects-core.");
